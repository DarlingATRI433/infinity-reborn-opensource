onEvent("lootjs", (event) => {
    ...
    event
        ...
        .addLoot('soulsweapons:essence_of_eventide');

    event
        .addEntityLootModifier('whisperwoods:hirschgeist')
        .addLoot('kubejs:soul_bone')
    ...
    event
        .addLootTypeModifier(LootType.CHEST)
        .hasAnyStage("difficulty_hard", "difficulty_impossible", "difficulty_impossibleplus")
        .randomChance(0.5)
        .addLoot("kubejs:jiushu_heart_shard")
    ...
    event
        ...
        .hasAnyStage("difficulty_impossible", "difficulty_impossibleplus")
        .addWeightedLoot([
    ...
    event
        ...
        .hasAnyStage("difficulty_impossible", "difficulty_hard", "difficulty_impossibleplus")
        .addWeightedLoot([
    ...
    event
        ...
        .hasAnyStage("difficulty_impossible", "difficulty_hard", "difficulty_impossibleplus")
        .addWeightedLoot([
            Item.of("victus:blank_heart_aspect")
        ])
    ...
    event
        .addLootTypeModifier(LootType.ENTITY)// 获取LootActionsBuilder
        .randomChance(0.1) // 战利品表条件：添加掉落概率
        .hasAnyStage("difficulty_impossible", "difficulty_hard", "difficulty_normal", "difficulty_impossibleplus")
        .addWeightedLoot([
    ...
    event
        .addLootTypeModifier(LootType.ENTITY)// 获取LootActionsBuilder
        .randomChance(0.005) // 战利品表条件：添加掉落概率
        .hasAnyStage("difficulty_impossible", "difficulty_impossibleplus")
        .addWeightedLoot([
    ...
    event
        .addLootTypeModifier(LootType.ENTITY)// 获取LootActionsBuilder
        .randomChance(0.015) // 战利品表条件：添加掉落概率
        .hasAnyStage("difficulty_impossible", "difficulty_hard", "difficulty_impossibleplus")
        .addWeightedLoot([1, 3], [
            Item.of("kubejs:shenqi_shard").withChance(70)
        ])
    ...
    event
        ...
        .hasAnyStage("difficulty_impossible", "difficulty_impossibleplus")
        .addWeightedLoot([
            Item.of("collectorsalbum:mythical_repacked_card_package")
        ])
    ...
    event
        .addEntityLootModifier("twilightforest:naga", "twilightforest:lich")// 获取LootActionsBuilder
        .randomChance(0.5) // 战利品表条件：添加掉落概率
        .hasAnyStage("difficulty_impossible", "difficulty_hard", "difficulty_impossibleplus")
        .addWeightedLoot([3, 7], [
    ...
    event
        .addEntityLootModifier("twilightforest:knight_phantom", "soulsweapons:draugr_boss", "soulsweapons:night_shade", "bosses_of_mass_destruction:lich", "bosses_of_mass_destruction:void_blossom", "terrarianslimes:king_slime")// 获取LootActionsBuilder
        .randomChance(1.0) // 战利品表条件：添加掉落概率
        .hasAnyStage("difficulty_impossible", "difficulty_impossibleplus")
        .addWeightedLoot([2, 6], [
            Item.of("mythicmetals:mythril_ingot").withChance(30),//秘银
    ...
    event
        ...
        .addWeightedLoot([3, 7], [
            ...
            Item.of("mythicmetals:banglum").withChance(1),//聚爆石
    ...
    event
        ...
        .addWeightedLoot([3, 7], [
            ...
            Item.of("mythicmetals:banglum").withChance(5),//聚爆石
    ...
    event
        ...
        .addWeightedLoot([3, 7], [
            ...
            Item.of("mythicmetals:banglum").withChance(10),//聚爆石
    ...
    event
        ...
        .randomChance(1.0) // 战利品表条件：添加掉落概率
        .hasAnyStage("difficulty_impossibleplus")
        .addWeightedLoot([
